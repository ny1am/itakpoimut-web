    ...
    <section className={styles.hero}>
      <div className="container">
        ...
        <p className={styles.info}>
          Тут ви можете перевірити, чи компанія використовує виключно українську
          мову, обслуговуючи своїх клієнтів в Україні.
        </p>
      ...
      <div className="container">
        <section className={styles.description}>
          <h1 className={styles.title}>
            <StandaloneQuote>И так поймут</StandaloneQuote> Каталог{' '}
        ...
        <section className={styles.nameSearch}>
          <h1 className={styles.title}>Шукайте компанії за назвою</h1>
          <p className={styles.text}>
        ...
        <section className={styles.categorySearch}>
          ...
          <p className={styles.text}>
            ...
            цікавить, серед списку зліва на сторінці <q>Всі компанії</q> або у
            стрічці пошуку на головній сторінці.
          </p>
          <Link className="page__button" to="/companies">
            Шукати за сферою
          </Link>
        ...
        <section className={styles.addCompany}>
          <h1 className={styles.title}>Додавайте компанії до нашої бази</h1>
          <p className={styles.text}>
            Допоможіть нам стати кращими, пропонуючи компанії, яких ще немає у
            базі. Ми зацікавлені у тому, аби наш сервіс представляв якомога
            більшу кількість різноманітних компаній - як лояльних до української
            мови, так і порушників. Зазначимо, що ви тільки пропонуєте компанію
            на розгляд. Після того її затверджує модератор, і система сама
            присвоює компанії статус лояльної/порушника на основі
            наявності/відсутності порушень.
          </p>
          <DialogLink to="/create-company" className="page__button">
